...
public class RedBelt extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_red_belt);

        SharedPreferences pref3 = getSharedPreferences("pref3", Activity.MODE_PRIVATE); // Shared Preference를 불러옵니다.
        ...
        // 저장된 값들을 불러옵니다
        String text1 = pref3.getString("editText1", "");
        String text2 = pref3.getString("editText2", "");
        String text3 = pref3.getString("editText3", "");
        String text4 = pref3.getString("editText4", "");
        String text5 = pref3.getString("editText5", "");
        String text6 = pref3.getString("editText6", "");
        String text7 = pref3.getString("editText7", "");
        String text8 = pref3.getString("editText8", "");
        String text9 = pref3.getString("editText9", "");
        String text20 = pref3.getString("editText20", "");
        String text21 = pref3.getString("editText21", "");
        String text22 = pref3.getString("editText22", "");
        String text23 = pref3.getString("editText23", "");
        String text24 = pref3.getString("editText24", "");
        String text25 = pref3.getString("editText25", "");
        String text26 = pref3.getString("editText26", "");

        Boolean chk1 = pref3.getBoolean("check1", false);
        Boolean chk2 = pref3.getBoolean("check2", false);
        Boolean chk3 = pref3.getBoolean("check3", false);
        Boolean chk4 = pref3.getBoolean("check4", false);
        Boolean chk5 = pref3.getBoolean("check5", false);
        Boolean chk6 = pref3.getBoolean("check6", false);
        Boolean chk7 = pref3.getBoolean("check7", false);
        Boolean chk8 = pref3.getBoolean("check8", false);
        Boolean chk9 = pref3.getBoolean("check9", false);
        Boolean chk10 = pref3.getBoolean("check10", false);
        Boolean chk20 = pref3.getBoolean("check20", false);
        Boolean chk21 = pref3.getBoolean("check21", false);
        Boolean chk22 = pref3.getBoolean("check22", false);
        Boolean chk23 = pref3.getBoolean("check23", false);
        Boolean chk24 = pref3.getBoolean("check24", false);
        Boolean chk25 = pref3.getBoolean("check25", false);
        Boolean chk26 = pref3.getBoolean("check26", false);
        ...
        btn1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if (edit1.getText().toString().equals("") || edit2.getText().toString().equals("") ||
                    ...
                    Toast.makeText(RedBelt.this, "빈칸에 0 입력해주세요",
    ...
    public void onStop(){ // 어플리케이션이 화면에서 사라질때
        super.onStop();
        SharedPreferences pref3 = getSharedPreferences("pref3", Activity.MODE_PRIVATE); // UI 상태를 저장합니다.
        SharedPreferences.Editor editor = pref3.edit(); // Editor를 불러옵니다.
    ...
    public void popup05(View view) {
        ...
        builder.setTitle("면접심화교육/면접캠프").setMessage("취업지원과 프로그램 개설시 개별신청(홈페이지로 공지)-수료자에 한해 취업지원과에서 일괄 포인트 입력");
    ...
    public void popup01(View view) {
        ...
        builder.setTitle("취업계획서").setMessage("오아시스-큰사람프로젝트 관리-취업계획서 메뉴-검사 후 결과 다운-큰사람 프로젝트 관리-포인트 신청(결과첨부)");
    ...
    public void popup02(View view) {
        ...
        builder.setTitle("취업지원과 상담").setMessage("오아시스-진로취업상담 예약-상담 후 취업지원과에서 일괄 포인트 입력");
    ...
    public void popup07(View view) {
        ...
        builder.setTitle("기업탐방/현장실습").setMessage("기업체험활동보고서 작성(증빙자료 준비)-오아시스-큰사람 프로젝트 관리-포인트 신청");
    ...
    public void popup08(View view) {
        ...
        builder.setTitle("입사지원서 클리닉").setMessage("취업지원과 프로그램 개설시 개별신청(홈페이지로 공지)-수료자에 한해 취업지원과에서 일괄 포인트 입력");
    ...
    public void popup09(View view) {
        ...
        builder.setTitle("기업인적성검사 교육").setMessage("취업지원과 프로그램 개설시 개별신청(홈페이지로 사전공지)-수료자에 한해 취업지원과에서 일괄 포인트 입력");
